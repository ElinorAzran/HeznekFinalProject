...
namespace Heznek.DataAccess.Migrations
{
    ...
    [Migration("20190206103155_AddAcademicStudiesNewFields")]
    partial class AddAcademicStudiesNewFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.AcademicStudiesEntity", b =>
                {
                    ...
                    b.Property<int?>("BeginningDegree");

                    b.Property<string>("FieldOfStudy");

                    b.Property<string>("FundStudies");
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.EventAttendeeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.EventEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.EventParticipantTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("EventParticipantTypes");
                });
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.TelephonyEntity", b =>
                {
                    b.Property<int>("Id");

                    b.Property<DateTime?>("DateBackFirst");

                    b.Property<DateTime?>("DateBackSecond");

                    b.Property<DateTime?>("DateBackThird");

                    b.Property<bool>("FundingAvailability");
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.EventAttendeeEntity", b =>
                {
                    b.HasOne("Heznek.DataAccess.Entities.EventEntity", "Event")
                        .WithMany("Attendees")
            ...
            modelBuilder.Entity("Heznek.DataAccess.Entities.TelephonyEntity", b =>
                {
                    b.HasOne("Heznek.DataAccess.Entities.ProfileEntity", "Profile")
                        .WithOne("Telephony")
                        .HasForeignKey("Heznek.DataAccess.Entities.TelephonyEntity", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
